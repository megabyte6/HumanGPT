...
export default class Game {
    ...
    async tryPrompt(player: Player, prompt: string) {
        ...
        let response = await this.gpt.getResponse(`Reply to the following prompt in at least 75 words using funny vocabulary. Immediately answer the question without confirming beforehand or saying "Here's an." Prompt: ${prompt}`)
